...
public:
    ...
    double getMatrixPresent(std::tuple<double, double> position) const;
    double getMatrixPresent(int i, int j) const;
    ...
    boostMatrix::matrix<double> getLocalMatrixPresence(std::tuple<double, double> position) const;
